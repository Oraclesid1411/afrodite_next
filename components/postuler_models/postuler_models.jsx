...
const handleCheckboxChange_R = (id, network) => {
  ...
  if (selectedOptions_rx.includes(network)) {
    ...
    setFormData((prevData) => {
      ...
      if (network === "whatsapp") {
        updatedFormData.postulant.for_whatsapp = false;
      } else if (network === "telegram") {
        updatedFormData.postulant.for_telegram = false;
      } else {
    ...
    setFormData((prevData) => {
      const updatedFormData = { ...prevData };
      if (network === "whatsapp") {
        updatedFormData.postulant.for_whatsapp = true;
      } else if (network === "telegram") {
        updatedFormData.postulant.for_telegram = true;
      } else {
        updatedFormData.postulant.for_other = {
          ...updatedFormData.postulant.for_other,
          [network]: true,
      ...
      case "influenceur":
        return (
          <form>
            ...
            <div className="vlogueuse_part">
            <div className="plateforme_container">
...
/>
              ...
              <div className="data_zone">
                <div className="icone_box">
                <FontAwesomeIcon icon={faYoutube} className="text-blue-500 mr-2" />
...
/>
              ...
              <div className="data_zone">
                <div className="icone_box">
                <FontAwesomeIcon icon={faTiktok} className="text-blue-500 mr-2" />
...
/>
          ...
          <div className="nbr_abonne_container">
          <label className="title_lbl">
            followers

          </label>
              <div className="nbr_abonne_box">
      ...
      {isWelcomeModalOpen && (
        <div className="modal-overlay welcome_msg" style={{ backgroundColor: "rgba(0, 0, 0, 0.8)" }} onClick={closeWelcomeModal}>
          ...
          >
            ...
            <p className="text-center">Aidez nous à cerner vos attentes pour...</p>

            <p className="text-center"> mieux vous servir!</p>
         
         <button onClick={closeWelcomeModal}>continuer<FontAwesomeIcon icon={faAnglesRight} /></button>
          </motion.div>
        </div>
      )}
        ...
        vous êtes:
            ...
            <div className="line_data_a">
              ...
              <input 
                 ...
                 className="input_padding " type="text"
                 placeholder="nom"
            ...
            <div className="line_data_a">
              ...
              <div className="half_col_a new_lbl_a">
                <div className="input_label_a">
                <label className="ext_label">
                  née le
              </label>
           ...
           />
             ...
             <div className="half_col_a new_lbl">
             
             <div className="bis_label">
              <label className="ext_label">
               votre taille
              </label>
...
<input type="tel" className="contact input_padding" placeholder="numéro"
 ...
 <div className="box_alredy_model">
  <div className="label_global">
    <label>vous êtes déja</label>
  </div>
 ...
 {/* </div> */}        
      ...
      <div className="lbl_title w-100 ">
        vous voulez 
        <span className="mini_txt">(vous pouvez cocher plusieurs options)</span>
        </div>
      {["mannequin", "hotesse",
       "influenceur",
        "se_former"
       , "rencontrer_afrodite"
        ...
        <div key={type} className="model_categorie">
